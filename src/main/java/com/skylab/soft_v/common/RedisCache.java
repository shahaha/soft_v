...
public class RedisCache<K,V> implements Cache<K,V> {
    ...
    private String cacheKey= Const.IDENTIFY_CACHE_KEY;
    ...
    public V get(K key) throws CacheException {
        ...
        try {
            ...
            //SimpleAuthorizationInfo simpleAuthenticationInfo = (SimpleAuthorizationInfo) JSONUtils.parse(rawValue.toString());
